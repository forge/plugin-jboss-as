...
public class DeploymentFailedException extends RuntimeException {
    ...
    public static DeploymentFailedException of(final String format, final Object... args) {
        return new DeploymentFailedException(String.format(format, args));
    }

    public static DeploymentFailedException of(final Throwable cause, final String format, final Object... args) {
        return new DeploymentFailedException(String.format(format, args), cause);
    }
}
